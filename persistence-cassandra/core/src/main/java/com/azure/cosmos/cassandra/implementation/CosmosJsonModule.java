...
/**
 * A Json serialization module with serializers and mix-ins for logging DataStax Java Driver 4
 * diagnostic strings.
 *
 * <p>This module is registered for use by {@link CosmosJson}. The serialization and mix-in types
 * that it contains augment, filter, and format properties for various DataStax Java Driver 4
 * classes. They provide access to driver state that is otherwise tedious to obtain. They are useful
 * in log messages and while debugging when detailed diagnostic strings are desirable.
 */
public final class CosmosJsonModule extends SimpleModule {
   ...
   *
   * <p>A single instance of this class is constructed by {@link CosmosJson}. No other uses are
   * supported.
   */
  ...
  private static com.fasterxml.jackson.core.Version getModuleVersion() {
    ...
    try (InputStream stream = loader.getResourceAsStream("maven-coordinates.properties")) {
      ...
      return new com.fasterxml.jackson.core.Version(
          major, minor, patch, snapshotInfo, groupId, artifactId);
      ...
      try {
        if (JsonSerializer.class.isAssignableFrom(cls)) {
          final JsonSerializer<Object> serializer =
              (JsonSerializer<Object>) cls.getDeclaredField("INSTANCE").get(null);
  ...
  @JsonAppend(
      props = @Prop(value = TypePropertyWriter.class, name = "type", type = String.class),
      prepend = true)
  ...
  public abstract static class BatchStatementMixIn extends RequestMixIn {
    ...
    /**
     * Specifies that {@link BatchStatement#iterator()} should be represented as a list-valued
     * property named {@code "statements"}.
     *
  ...
  @JsonAppend()
  @JsonPropertyOrder(
      value = {"sessionName", "startupOptions"},
      alphabetic = true)
  ...
  /**
   * A mix-in for serializing {@link com.datastax.oss.driver.api.core.cql.ExecutionInfo} instances
   * to JSON.
   */
  @JsonAppend()
  ...
  @JsonAppend()
  @JsonPropertyOrder(
      value = {"endPoint", "datacenter", "distance", "hostId", "schemaVersion"},
      alphabetic = true)
  @JsonIncludeProperties({
    "cassandraVersion",
    "datacenter",
  ...
  @JsonAppend()
  @JsonPropertyOrder(
      value = {"query", "namedValues", "positionalValues"},
      alphabetic = true)
  ...
  public abstract static class SpeculativeExecutionPolicyMixIn {
    public static final Class<SpeculativeExecutionPolicy> HANDLED_TYPE =
        SpeculativeExecutionPolicy.class;
  }

  /** A mix-in for serializing {@link Throwable} instances to JSON. */
  @JsonAppend(
      props = @Prop(value = TypePropertyWriter.class, name = "error", type = String.class),
      prepend = true)
  @JsonPropertyOrder(
      value = {"cause", "message", "stackTrace", "suppressed"},
      alphabetic = true)
  ...
  /**
   * A {@link VirtualBeanPropertyWriter property writer} for adding the {@link Class#getName class
   * name} to the JSON representation of an object.
   *
   * <p>Use it with {@link JsonAppend} to add virtual properties in addition to regular ones.
   *
   * @see ThrowableMixIn
   */
  public static final class TypePropertyWriter extends VirtualBeanPropertyWriter {
     ...
     *
     * <p>Jackson requires a parameterless constructor for all {@link PropertyWriter} classes.
     */
     ...
     * Initializes a newly created {@link TypePropertyWriter}.
     *
     * <p>Jackson requires a constructor with these parameters for all {@link PropertyWriter}
     * classes.
     *
    ...
    protected Object value(
        final Object bean, final JsonGenerator generator, final SerializerProvider provider) {
