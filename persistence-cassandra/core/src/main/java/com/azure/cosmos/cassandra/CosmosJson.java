 ...
 *
 * <p>This class is used in log messages, test code, and {@linkplain Object#toString toString}
 * implementations. It is especially useful for producing detailed diagnostic strings for
 * troubleshooting DataStax Java Driver issues.
 */
public final class CosmosJson {
   ...
   *
   * <p>This method may be used for specialized serialization tasks. It is less expensive than
   * instantiating one of your own and ensures that values are serialized consistently.
   *
   ...
   */
  public static <T> T readValue(@NonNull final File file, @NonNull final Class<T> type)
      throws IOException {
   ...
   * @throws IOException if a low-level I/O problem (unexpected end-of-input, network error) occurs.
   */
  public static <T> T readValue(@NonNull final InputStream stream, @NonNull final Class<T> type)
      throws IOException {
   ...
   * @throws IOException if a low-level I/O problem (unexpected end-of-input, network error) occurs.
   */
  public static <T> T readValue(@NonNull final String string, @NonNull final Class<T> type)
      throws IOException {
  ...
  public static String toJson(@Nullable final Object value) {
    try {
      ...
      LOG.trace(
          "could not convert {} value to JSON due to:",
  ...
  /**
   * Converts the given value to a string of the form
   * <i>&lt;simple-class-name&gt;</i><b>("</b><i>&lt; json-string&gt;</i><b>)</b>").
   *
   * <p>This method is frequently used {@linkplain Object#toString toString} implementations.
   *
   * @param value The value to convert.
  ...
  public static String toString(@Nullable final Object value) {
    if (value != null) {
      final String name =
          INSTANCE.simpleClassNames.computeIfAbsent(value.getClass(), Class::getSimpleName);
